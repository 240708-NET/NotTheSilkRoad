...
namespace Tests
{
    public class CategoryServiceTests
    {
        ...
        {
            // Arrange
            var categoryToDelete = new Category { Id = 1, Description = "Category to delete", Products = new List<Product>() };
        ...
        {
            // Arrange
            var categoryToUpdate = new Category { Id = 1, Description = "Updated Category", Products = new List<Product>() };
